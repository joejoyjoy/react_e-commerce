...
function Completed({ list, deleteItem, handleSetComplete }) {

    let activeList = list.filter(activeItem => activeItem.done == true);
        ...
        <ul className='unordered-list'>
            {activeList.map((activeItem) =>
                <li key={activeItem.id} className='pages-list'>
                    {
                        activeItem.done ? (
                            <div onClick={() => handleSetComplete(activeItem.id)} className='pages-list-checked_completed' >
